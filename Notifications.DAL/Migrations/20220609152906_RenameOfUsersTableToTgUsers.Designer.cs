...
namespace Notifications.DAL.Migrations
{
    ...
    [Migration("20220609152906_RenameOfUsersTableToTgUsers")]
    partial class RenameOfUsersTableToTgUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Notifications.DAL.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Notifications.DAL.Models.RefreshToken", b =>
                {
                    b.HasOne("Notifications.DAL.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
